    ...
    */
    ...
    contract('EsusuService', () => {
        ...
        it('EsusuService Contract: Should Join The Current Esusu Cycle', async () => {
            ...
            var pricePerFullShare1 = await daiLendingServiceContract.GetPricePerFullShare();
            ...
            var pricePerFullShare2 = await daiLendingServiceContract.GetPricePerFullShare();
